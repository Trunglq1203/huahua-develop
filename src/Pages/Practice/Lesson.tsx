...
const Lesson: React.FC<ILesson> = ({ part, title, success, total, isLock,isListening,answer }) => {
  const path = isListening ? `/question?type=listen&answertype=${answer}` : `/question?answertype=${answer}`;
